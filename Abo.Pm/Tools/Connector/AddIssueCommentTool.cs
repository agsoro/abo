...
public class AddIssueCommentTool : IAboTool
{
    ...
    public string Description => "Adds a comment to an existing issue in the configured issue tracker. ONLY use this if strictly necessary. Do NOT duplicate content—your 'resultNotes' from 'conclude_step' are automatically added as a comment to the issue.";
